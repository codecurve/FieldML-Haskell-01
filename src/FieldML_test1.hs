...
tests = [ testGroup "Sorting Group 1" [
  testCase "message" testBooleanExpression1a,
  testCase "message" testBooleanExpression1b,
  testCase "message" testBooleanExpression1c,
  testCase "message" testBooleanExpression1d,
  testCase "message" testBooleanExpression1e,
  testCase "message" testSubset1a,
  testCase "message" testmatch1a,
  testCase "message" test2dTupleMapDomain1a,
  testCase "message" test2dTupleMapDomain1b,
  testCase "message" test2dTupleMapDomain1c,
  testCase "message" test2dTupleMapDomain1d,
  testCase "message" testLambdaTuple_domain,
  testCase "message" testLambdaTuple_codomain,
  testCase "message" testLambdaTuple_freeVariables,
  testCase "message" testLambdaTuple_valid,
  testCase "message" testTuple_freeVariables,
  testCase "message" testSimplex2dPredicate,
  testCase "message" testValidate_lambdaRhs_noCommonVars,
  testCase "message" testCast_TupleToDisjointUnion1,
  testCase "message" testCast_TupleToDisjointUnion2,
  testCase "message" testDomainPolarToCartesian,
  testCase "message" testDomain_PartialApplication,
  testCase "message" testRestrictionForCircle,
  testCase "message" testResult8,
  testCase "message" testIntParam_01a,
  testCase "message" testIntParam_01b,
  testCase "message" testIntParam_01c,
  testCase "message" testIntParam_01d,
  testCase "message" testPredicate2b,
  testCase "message" testPartialApplication,
  testCase "message" testKroneckerProduct2d,
  testCase "message" testKroneckerProduct3d,
  testCase "message" testExists1a,
  testCase "message" testExists1b,
  testCase "message" testExists1c,
  testCase "message" testExists1d,
  testCase "message" testExists1e,
  testCase "message" testExists1f,
  testCase "message" testExists1g1,
  testCase "message" testExists1g2,
  testCase "message" testnormallyDistributedVariable1,
  testCase "message" testWhere,
  testCase "message" testTuples_And_DisjointUnionValue,
  testCase "message" testProject_NonTuple,
  testCase "message" testSimpleContraction,
  testCase "message" testpressureFieldViaTemplate2,
  testCase "message" testgeometricFieldViaTemplate,
  testCase "message" testSubset_CommutesWith_CartesianProduct_Case,
  testCase "message" testLibrary_basis2dLinearLagrange_Apply_In_unitSquare1,
  testCase "message" testLibrary_basis2dLinearLagrange_Apply_In_unitSquare2,
  testCase "message" testLinearLagrange1_valid,
  testCase "message" testLinearLagrange2_valid,
  testCase "message" testLinearLagrange3_valid,
  testCase "message" testCubicHermite1_valid,
  testCase "message" testCubicHermite2_valid,
  testCase "message" testCubicHermite3_valid,
  testCase "message" testCustomMixedBasis_valid
  ]]
